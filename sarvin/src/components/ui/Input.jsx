...
const Input = (
  ({ label, error, fullWidth = false, leftIcon, rightIcon, className = '', ...props }, ref) => {
    const baseStyles = 'rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-900 placeholder-gray-500 focus:border-[#2A4365] focus:outline-none focus:ring-1 focus:ring-[#2A4365]';
