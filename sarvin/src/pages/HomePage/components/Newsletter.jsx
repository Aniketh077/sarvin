...
const handleSubmit = async (e) => {
  ...
  <input
    ...
    className="flex-1 px-6 py-4 text-gray-900 my-2 sm:my-0  focus:outline-none focus:ring-2 focus:ring-[#22C55E]"
    required
  ...
  <button
    type="submit"
    disabled={newsletterSubscribing}
    className="bg-[#22C55E] hover:bg-[#16A34A] px-8 py-4   font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
  >
